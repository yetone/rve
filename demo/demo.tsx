...
function App() {
    ...
    return (
        <div>
            <p>
                {state.user.age}-year-old {state.user.name} clicked {count.value} times
            </p>
            ...
            <div style={{ marginTop: 20 }}>
                ...
                <p>
                    ...
                    <input
                        ...
                        onChange={e => (state.user.age = parseInt(e.target.value, 10))}
                    />
                </p>
                <p>
            ...
            <div style={{ marginTop: 20 }}>
                ...
                <input
                    type='number'
                    value={state.a.b.c.d}
                    onChange={e => (state.a.b.c.d = parseInt(e.target.value, 10))}
                />
            </div>
            <div style={{ marginTop: 20 }}>
            ...
            <div style={{ marginTop: 20 }}>
                {state.users.map((u, i) => (
                    <button key={`user-btn-${i}`} onClick={() => u.age++}>
